...
export const GraduationCap: React.FC<IconProps> = ({ className }) => (
...
export const Code2: React.FC<IconProps> = ({ className }) => (
...
export const FolderGit2: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M9 20v-5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v5"/><path d="M12 11V5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/></svg>
);

export const Award: React.FC<IconProps> = ({ className }) => (
...
export const Languages: React.FC<IconProps> = ({ className }) => (
